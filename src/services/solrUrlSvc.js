...
export function solrUrlSvc() {
  ...
  this.parseSolrUrl = function(solrReq) {
    ...
    var parseUrl = function(url) {
      // Use URL constructor for Node.js compatibility
  ...
  this.escapeUserQuery = function(queryText) {
    var escapeChars = ['+', '-', '&', '!', '(', ')', '[', ']',
      '{', '}', '^', '"', '~', '*', '?', ':', '\\'];
    // Create regex pattern with escaped characters
    var pattern = escapeChars.map(function(char) {
