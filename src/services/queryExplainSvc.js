...
export function queryExplainSvc(baseExplainSvc, vectorSvc, simExplainSvc) {
  ...
  this.CoordExplain = function(explJson, coordFactor) {
    if (coordFactor < 1.0) {
      ...
      this.vectorize = function() {
        ...
        Object.keys(this.influencers()).forEach(function(infl) {
  ...
  this.DismaxTieExplain = function(explJson, tie) {
    ...
    this.vectorize = function() {
      ...
      Object.keys(infl.slice(1)).forEach(function(currInfl) {
  ...
  this.SumExplain = function() {
    ...
    this.influencers = function() {
      ...
      Object.keys(this.children).forEach(function(child) {
        ...
        if (Object.prototype.hasOwnProperty.call(child, 'isSumExplain') && child.isSumExplain) {
          Object.keys(child.influencers()).forEach(function(grandchild) {
